<?php
  ...
  if(isset($_SESSION['searcherrors']) && !empty($_SESSION['searcherrors'])){
      $err = $_SESSION['searcherrors'];
      
      echo "<script>
               alert('" . $err . "');
            </script>";  
    
      unset($_SESSION['searcherrors']);
    }   
?> 
...
<html lang="en" style="height: 100%">
  ...
  <body style="height: 100%" onload="prepare()">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    ...
	    <a href="result.php" class="btn btn-outline-light my-2 my-sm-0">Search</a>
	  </div>
	</nav>
	<div class="row full">
		<div class="col-md-4 white-color bor-r"></div>
		<div class="col-md-4" id="imgcontent">
